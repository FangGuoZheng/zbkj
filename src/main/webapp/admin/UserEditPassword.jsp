...
<head>
    ...
    <!-- 自定义JS -->
    <script src="${pageContext.request.contextPath}/admin/js/UserEditPassword.js"></script>
</head>
<body>
	<script type="text/javascript">
		var userIdWithUserEditPass=<%=request.getParameter("id") %>;
	...
	<div class="container">
		...
		<p class="lead"><span class="glyphicon glyphicon-list"></span>修改用户密码</p>
	    <form class="form-horizontal">
	    <div style="padding-top:100px;">
	       <div class="form-group">
	          <div class="col-sm-3"></div>
	          <label for="mobile-input" class="col-sm-1 control-label codeSubmitLabel">手机号:</label>
			  <div class="col-sm-4">
