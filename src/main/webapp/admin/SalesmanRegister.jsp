...
<head>
    ...
    <!-- 自定义JS -->
    <script src="${pageContext.request.contextPath}/admin/js/SalesmanRegister.js"></script>
    
</head>
<body>
	<!-- 整个页面外层container -->
	<div class="container">
		<p class="lead"><span class="glyphicon glyphicon-list"></span>注册用户</p>
	    <form class="form-horizontal">
	    <div style="padding-top:100px;">
	       <div class="form-group">
	          <div class="col-sm-3"></div>
	          <label for="name-input" class="col-sm-1 control-label codeSubmitLabel">账号:</label>
			  <div class="col-sm-4">
		   ...
		   <div class="form-group">
	          <div class="col-sm-3"></div>
	          <label for="name-input" class="col-sm-1 control-label codeSubmitLabel">密码:</label>
			  <div class="col-sm-4">
		   ...
		   <div class="form-group">
	          <div class="col-sm-3"></div>
	          <label for="name-input" class="col-sm-1 control-label codeSubmitLabel">确认密码:</label>
			  <div class="col-sm-4">
		   ...
		   <div class="form-group">
			...
			<div class="form-group">
				<div class="col-sm-3"></div>
				<label for="name-input" class="col-sm-1 control-label codeSubmitLabel">角色:</label>
				<div class="col-sm-4">
					<select name="roleId" class="form-control" id="roleId" aria-describedby="basic-addon2">
			...
			<div class="form-group">
				<div class="col-sm-3"></div>
				<label for="name-input" class="col-sm-1 control-label codeSubmitLabel">电话号码:</label>
				<div class="col-sm-4">
		   ...
		   <div class="form-group">
			  ...
			  <div class="col-sm-4">
				  <input type="text" class="form-control" id="email-input" aria-describedby="basic-addon2">
			   </div>
		   </div>
			<div class="form-group">
				<div class="col-sm-3"></div>
				<label for="name-input" class="col-sm-1 control-label codeSubmitLabel">密码提示问题:</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				<div class="col-sm-3"></div>
				<label for="name-input" class="col-sm-1 control-label codeSubmitLabel">问题答案:</label>
				<div class="col-sm-4">
