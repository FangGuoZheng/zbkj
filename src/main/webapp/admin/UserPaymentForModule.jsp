			...
			<div class="modal-body">
				<form>
					<div class="input-group form-group" id="mobileInput">
						你确定给<span style="color:#FF0000;font-weight:bold;" id="mobileInput1"></span>用户在<span style="color:#FF0000;font-weight:bold;" id="mobileInput2"></span>模块上充值<span style="color:#FF0000;font-weight:bold;" id="mobileInput3"></span>元吗？
					</div>
					&nbsp;&nbsp;&nbsp;&nbsp;
